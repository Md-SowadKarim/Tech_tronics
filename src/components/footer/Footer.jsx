...
const Footer = () => {
    ...
    return (
        <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12 bg-white dark:bg-gray-900">
            <div className="flex flex-col items-center justify-center">
                <div className='bold'>
                    <h1 className="font-extrabold text-3xl">Tech-tronics</h1>
                    <hr data-aos="fade-left" className='h-1 bg-blue-500 w-[50%] my-2'/>
                </div>
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 dark:text-white">
                        2023 <span className="font-semibold">Tech-tronics</span>
                    </p>
                    <div className="border-l dark:text-white pl-2 ml-2">
